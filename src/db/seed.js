...
async function seed() {
  ...
  await db.query("INSERT IGNORE INTO branches (branch_name) VALUES ('SOF Branch')");
  ...
  const teachers = [
    ...
    { name: "Mrs. Sunita Rao",  email: "sunita@meritome.com",  phone: "9876543221", location: "SOF Branch",     subjects: ["Chemistry","Biology"] },
